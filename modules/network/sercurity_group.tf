...
//** Techlab homepage Security group Module **//
...
//** Techlab management Security group Module **//
resource "aws_security_group" "techlab_management_fe_allow_https" {
  name        = "opegpt-${var.environment_name}-common-elb-global-techlab-management-fe"
  description = "ELB global security group"
  vpc_id      = data.aws_subnet.subnet_public_1a.vpc_id
